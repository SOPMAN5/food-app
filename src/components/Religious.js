...
<input id="input__name" className="floating__input" name="Company-name"  placeholder="Church/Mosque name"  required/>
<label for="input__name" className="floating__label" data-content="Church/Mosque name*">
